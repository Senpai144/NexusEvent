...
import { Zap, Mail, Lock, Eye, EyeOff, User, ArrowRight, Globe, CheckCircle, AlertCircle } from 'lucide-react'
import { useAuth } from '../contexts/AuthContext'

const PERKS = ['Créez jusqu\'à 5 événements gratuitement', 'Accès à votre dashboard organisateur', 'Support par email inclus', 'Aucune carte bancaire requise']
      ...
      <div className="hide-mobile" style={{ flex: 1, background: 'var(--bg2)', borderRight: '1px solid var(--border)', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: 60, position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', maxWidth: 420 }}>
          ...
          <h2 style={{ fontSize: '2.2rem', fontWeight: 800, marginBottom: 16, letterSpacing: '-0.02em' }}>
            Rejoignez déjà des milliers d'organisateurs
          </h2>
          <p style={{ color: 'var(--text2)', lineHeight: 1.7, marginBottom: 36 }}>
            Créez votre premier événement en quelques minutes. Aucun paiement nécessaire pour démarrer.
          </p>
